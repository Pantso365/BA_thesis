...
def get_metadata():
    ...
    user_metadata.fillna(value=np.nan, inplace=True)
    ...
    user_metadata = user_metadata.rename(columns={'created_at': 'created', 'default_profile_image': 'DefaultImage',
                                                  'favourites_count': 'numLikes', 'followers_count': 'numFollowers',
                                                  'friends_count': 'numFollowing',
                                                  'listed_count': 'numGroups', 'statuses_count': 'numStatuses',
